...
const api = {
  ...
  getFotoDubbels: () => apiFetch("/api/admin/fotodubbels"),
  ruimFotoDubbelsOp: (groepen) => apiFetch("/api/admin/fotodubbels/opruimen", { method: "POST", body: JSON.stringify({ groepen }) }),
  getCockpitMetrics: () => apiFetch("/api/admin/metrics"),
  getEvaluatie: (tripId) => apiFetch(`/api/trips/${tripId}/evaluatie`),
  slaEvaluatieFotosOp: (tripId, top) => apiFetch(`/api/trips/${tripId}/evaluatie/fotos`, { method: "PUT", body: JSON.stringify({ top }) }),
  ...
  getSpelScores: (tripId) => apiFetch(`/api/trips/${tripId}/spellen`),
  slaSpelScoreOp: (tripId, spel, score) => apiFetch(`/api/trips/${tripId}/spellen/${spel}`, { method: "POST", body: JSON.stringify({ score }) }),
  ...
  startFotoboekPdf: (id) => apiFetch(`/api/photobooks/${id}/pdf`, { method: "POST", body: "{}" }),
  haalTaak: (id) => apiFetch(`/api/taken/${id}`),
